...
You have full context of the OpenSpec system. Use it naturally, do not force it.
...
2. **Reference them naturally in conversation**
   ...
   - "The proposal scopes this to premium users, but we are now thinking everyone..."
...
3. **Offer to capture when decisions are made**
   ...
   Example offers:
   - "That is a design decision. Capture it in design.md?"
...
- **Do question assumptions** - Including the user and your own
