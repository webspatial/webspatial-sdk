...
export function ToolbarTest() {
    return <>
        <div style={{ backgroundColor: "#FF000000", width: "100%", height: "500px", padding: "0px" }}>
            <div style={{ backgroundColor: "#FF000000", height: "100%", display: "flex", flexDirection: "row", alignItems: "center" }}>
                <SpatialDiv spatialStyle={{ position: { z: 10, x: 0 }, cornerRadius: 30, glassEffect: true }} style={{ display: "flex", flexDirection: "column", width: "50px", flexShrink: "0", marginRight: "-50px", padding: "5px" }}>
                    <button>😍</button>
                    <button>👌</button>
                    <button>😊</button>
                    <button>😇</button>
