...
**Historical follow-up:** the original PR 4 text listed `SSRProvider` as part of the default-entry utilities; public `SSRProvider` / `SSRContext` were removed later — see `.changeset/remove-ssr-provider.md`.
