...
The React SDK adds runtime capability checks via `WebSpatialRuntime` (re-exporting `@webspatial/core-sdk/runtime`) and updates spatialized components and related hooks so behavior matches runtime availability.
