          ...
          <label className="inline-flex items-center cursor-pointer">
            <input type="checkbox" value="" className="sr-only peer" onChange={async (e) => {
              if (e.target.checked) {
                ...
                if (!created) {
                  setCreated(true)
                  await WebSpatial.createDOMModel(WebSpatial.getImmersiveWindowGroup(), "x", "testModel", "http://10.73.196.42:5173/src/assets/FlightHelmet.usdz")
          ...
          <button className="select-none px-4 py-1 text-s font-semibold rounded-full border border-gray-700 hover:text-white bg-gray-700 hover:bg-gray-700 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-offset-2"
            onClick={async (e) => {
              if (volumetricWG.id === "") {
                ...
                await WebSpatial.createDOMModel(volumetricWG, "myPanel2", "testModel", "http://10.73.196.42:5173/src/assets/FlightHelmet.usdz")
                setTimeout(() => {
