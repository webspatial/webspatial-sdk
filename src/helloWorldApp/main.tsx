...
import { SpatialIFrame } from '../../lib/webSpatialComponents'
            ...
            <input type="checkbox" value="" className="sr-only peer" onChange={async (e) => {
              if (e.target.checked) {
                ...
                if (!created) {
                  ...
                  let helmetModel = await WebSpatial.createResource("ModelComponent", WebSpatial.getImmersiveWindowGroup(), { modelURL: "http://npmURL:5173/src/assets/FlightHelmet.usdz" });
...
var main = async () => {
  setTimeout(async () => {
    ...
    // await WebSpatial.createDOMModel("root", "root", "testModel", "http://npmURL:5173/src/assets/FlightHelmet.usdz")
