...
var main = async () => {
    ...
    if (page == "default") {
        ...
        var panel = await WebSpatial.createWebPanel(WebSpatial.getCurrentWindowGroup(), "http://npmURL:5173/testList.html")
        ...
        let ballModel = await WebSpatial.createResource("ModelComponent", { modelURL: "http://npmURL:5173/src/assets/ball.usdz" });
        let helmetModel = await WebSpatial.createResource("ModelComponent", { modelURL: "http://npmURL:5173/src/assets/FlightHelmet.usdz" });
