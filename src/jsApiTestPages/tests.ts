...
var main = async () => {
    ...
    if (page == "default") {
        ...
        webview.data.url = "http://npmURL:5173/testList.html"
        ...
        let ballModel = await WebSpatial.createResource("ModelComponent", WebSpatial.getCurrentWindowGroup(), WebSpatial.getCurrentWebPanel(), { modelURL: "http://npmURL:5173/src/assets/ball.usdz" });
        let helmetModel = await WebSpatial.createResource("ModelComponent", WebSpatial.getCurrentWindowGroup(), WebSpatial.getCurrentWebPanel(), { modelURL: "http://npmURL:5173/src/assets/FlightHelmet.usdz" });
