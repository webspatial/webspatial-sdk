...
- [x] 1.3 Add deterministic generation that combines the checked-in source with platform package version and build provenance to produce the embedded visionOS manifest.
