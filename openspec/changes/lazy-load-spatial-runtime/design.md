...
- Re-exports Group B / C utilities and type-only surface from `./index` by reference. This keeps `enableDebugTool`, `convertCoordinate`, `initScene`, `WebSpatialRuntime`, `version`, `createElement`, and future stateless additions byte-identical between entries.
