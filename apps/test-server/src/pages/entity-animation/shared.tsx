...
export function fmtVec3(v: Vec3 | undefined): string {
  if (!v) return '-'
...
export function EntityAnimationPageShell({
  title,
  description,
  children,
}: {
...
export function EntityAnimationOverview() {
  return (
