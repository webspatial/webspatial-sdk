...
const StyledElement = styled.div<{
  ...
  content-visibility: ${props => props.contentVisibility};
      ...
      <div className="max-w-3xl mx-auto space-y-4">
        ...
        <div className="bg-gray-800 p-4 rounded-lg">
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="p-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors">
              <center>ContentVisibility</center>
            </div>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <select
                value={contentVisibility}
                onChange={applyInlineStyleContentVisibility}
                className="p-2  bg-purple-50 text-black rounded-lg transition-colors"
                style={{ flex: 1 }}
              >
                <option value="visible">visible</option>
              ...
              <button
                onClick={removeInlineStyleContentVisibility}
                className="p-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition-colors"
                style={{ width: '100px', marginLeft: '10px' }}
              >
                remove
        ...
        <div className="bg-gray-800 p-4 rounded-lg">
          ...
          {styleMode == 'In-line style' ? (
            ...
            <div className="testElement w-32 h-32 bg-gradient-to-r bg-opacity-15 bg-red-200/30  rounded-lg flex items-center justify-center text-white   ">
              CSS Module State
            </div>
          ) : (
            <StyledElement
