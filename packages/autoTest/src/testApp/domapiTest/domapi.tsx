...
function DomApiTest() {
  ...
  const onSpatialRotateStart = (event: SpatialRotateStartEvent) => {
    console.log('onSpatialRotateStart', event.target)
  }
  ...
  const onSpatialMagnifyStart = (event: SpatialMagnifyStartEvent) => {
    console.log('onSpatialMagnifyStart', event.target)
  }
