  ...
  return (
    <div className="min-h-screen bg-gray-900 p-4">
      ...
      <div className="max-w-3xl mx-auto space-y-4">
        <div enable-xr style={transformStyle} data-testid="transform-target">
          box
          <div
            enable-xr
            style={nestedTransformStyle}
          ...
          <div className="p-4 rounded-lg col-span-1">
            ...
            <div>
              ...
              <input
                ...
                data-testid="nested-transform-translate-x"
              />
            ...
            <div>
              ...
              <input
                ...
                data-testid="nested-transform-matrix3d"
              />
