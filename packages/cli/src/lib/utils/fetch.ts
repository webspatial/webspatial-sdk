...
const userAgent =
  'Mozilla/5.0 (X11; Linux x86_64; PICO 4 OS5.5.0 like Quest) AppleWebKit/537.36 (KHTML, like Gecko) PicoBrowser/3.3.24 Chrome/105.0.5195.68 VR Safari/537.36  OculusBrowser/7.0'
...
export async function fetch(
  ...
  return await fetchh2(
    input,
    headers ? { redirect: 'follow', ...headers } : { redirect: 'follow' },
  )
}
...
export function decompressResponseBuffer(
  buffer: Buffer,
