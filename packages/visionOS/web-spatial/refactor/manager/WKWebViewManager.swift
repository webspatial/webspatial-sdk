...
class WKWebViewManager {
    ...
    func create(controller: SpatialWebController, configuration: WKWebViewConfiguration? = nil) -> WKWebView {
        ...
        // TODO: get native api instead of PACKAGE_VERSION
        controller.webview!.customUserAgent = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7; wv) AppleWebKit\(webviewVersion)WebSpatial/\("PACKAGE_VERSION")"
